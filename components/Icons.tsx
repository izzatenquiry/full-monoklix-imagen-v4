...
export const AppleIcon: React.FC<{ className?: string; title?: string; }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 20.94c1.5 0 2.75 1.06 4 1.06 3 0 6-8 6-12.22A4.91 4.91 0 0 0 17 5c-2.22 0-4 1.44-5 2.06A5.06 5.06 0 0 0 7 5a4.91 4.91 0 0 0-5 4.72c0 4.22 3 12.22 6 12.22 1.25 0 2.5-1.06 4-1.06Z"/><path d="M10 2c1 .5 2 2 2 5"/>
  </svg>
);
...
export const DownloadIcon: React.FC<{ className?: string; title?: string; }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const GoogleDriveIcon: React.FC<{ className?: string }> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M7.71,3.5,1.15,14.29a0.25,0.25,0,0,0,.21,.39L7.85,15,11,9.25Z"></path>
        <path d="M8.29,15.1,12,21.5,22.79,4.21a0.25,0.25,0,0,0-.22-0.39l-6.52-.06Z"></path>
        <path d="M22.85,4.2,16,3.5,12,9.75l4,6.75,6.56-0.09a0.25,0.25,0,0,0,.22-0.39Z"></path>
    </svg>
);
...
export const MailIcon: React.FC<{ className?: string }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const RefreshCwIcon: React.FC<{ className?: string; title?: string; }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const RobotIcon: React.FC<{ className?: string }> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M16 8V4.02a2.02 2.02 0 0 0-2.02-2.02H10.02A2.02 2.02 0 0 0 8 4.02V8" />
...
export const StoreIcon: React.FC<{ className?: string }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="m2 7 4.41-4.41A2 2 0 0 1 7.83 2h8.34a2 2 0 0 1 1.42.59L22 7"/><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><path d="M15 22v-4a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v4"/><path d="M2 7h20"/><path d="M22 7H12v4a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V7H2"/>
  </svg>
);
...
export const TerminalIcon: React.FC<{ className?: string; title?: string; }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const TrashIcon: React.FC<{ className?: string; title?: string; }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const VideoIcon: React.FC<{ className?: string; title?: string; }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const WandIcon: React.FC<{ className?: string; title?: string; }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const WebhookIcon: React.FC<{ className?: string }> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M18 16.98h-5.22a4 4 0 1 1 0-7.96H18"></path>
    <path d="M18 16.98v-1.85a1.5 1.5 0 0 1 1.5-1.5H21a1.5 1.5 0 0 1 1.5 1.5v1.85"></path>
    <path d="M18 9.02V7.17a1.5 1.5 0 0 0-1.5-1.5H15a1.5 1.5 0 0 0-1.5 1.5v1.85"></path>
    <path d="m12.78 9-2.56-2.56"></path>
    <path d="M10.22 11.56 12.78 9"></path>
    <path d="m12.78 15-2.56 2.56"></path>
    <path d="M10.22 12.44 12.78 15"></path>
    <path d="M6 12H4.22a1.5 1.5 0 0 1-1.5-1.5V8.67a1.5 1.5 0 0 1 1.5-1.5H6"></path>
    <path d="M6 12h1.78a1.5 1.5 0 0 0 1.5-1.5V8.67a1.5 1.5 0 0 0-1.5-1.5H6"></path>
  </svg>
);
