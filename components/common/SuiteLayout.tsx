...
const SuiteLayout: React.FC<SuiteLayoutProps> = ({ title, subtitle, icon: Icon, children }) => {
    return (
        <div className="w-full max-w-[1600px] mx-auto flex flex-col md:pb-6 relative">
            ...
            {title && (
                <div className="flex-shrink-0 mb-4 md:mb-8 px-2 mt-2 md:mt-4 animate-zoomIn">
            ...
            <div className="flex-1 holo-card p-4 md:p-6 flex flex-col relative z-10 animate-zoomIn" style={{ animationDelay: '100ms' }}>
